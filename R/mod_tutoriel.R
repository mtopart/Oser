...
mod_tutoriel_ui <- function(id){
  ...
  tagList(
    ...
    h1("Tutoriels"),
    br(),
    div("Oser est un calculateur 'crash-test', qui permet de tester la capacit\u00e9 d'un atelier \u00e0 encaisser une variation de production, 
    ...
    div("Le choix du solde final est laiss\u00e9 librement \u00e0 l'utilisateur en fonction de son besoin. 
